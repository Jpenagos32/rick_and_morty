    ...
    return (
        <div className="about">
            ...
            <p className='aboutMe'>
                ...
                <br />
                <br />
                Soy desarrollador web full stack en proceso actualmente, estudiante de Henry.
                <br />
                <br />
                ...
                Si necesitas un desarrollador con experiencia en React, JavaScript, o PHP puedes ponerte en contacto conmigo.
                con gusto responderé tus mensajes!
            </p>
            <div className='aboutLogos'>
                ...
                <a href="https://github.com/Jpenagos32" target='_blank'>
                    <img className='aboutGithubLogo' src={GithubLogo} alt="Github Icon" />
                </a>
            </div>
